...
public class PlataformaBasicaPool : MonoBehaviour
{
    ...
    private static PlataformaBasicaPool instance;
    public static PlataformaBasicaPool Instance { get { return instance; } }
